...
const AdminRolesCreatePage = ({ user }) => {
    ...
    const header = (
        <PageHeader pretitle="admin" title="Role" button={<BackButton />} separator={true}>
            Create
        </PageHeader>
    );
                ...
                <HorizontalList itemSize="stretch">
                    <ListItem style={{ marginRight: "1rem" }}>
                        <div className="form-group">
                            ...
                            <Switch
                                checked={formInput.isAdmin || false}
                                onChange={() => {
                                    setFormInput({
                                        ...formInput,
...
export default withAuth(AdminRolesCreatePage);