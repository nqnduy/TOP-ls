...
import {
    ...
    checkPermission, trackingContentRef, isFile,
    postGetForm, preSaveForm
                                    ...
                                    <TabPane forceRender={true} tab={locales[locale]} key={locale}>
                                        ...
                                        <HorizontalList>
                                            <ListItem style={{ marginRight: "1rem" }}>
                                                ...
                                                >
                                                    {(formInput.code && pageSectionOptions[formInput.code]) ? pageSectionOptions[formInput.code].map(function (name, index) {
                                                        return (
