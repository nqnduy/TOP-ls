...
import {
    showMessages, showSuccess, showError, checkPermission,
    strToSlug, postGetForm, preSaveForm
...
const AdminJobsCreatePage = ({ user }) => {
                        ...
                        ? <HorizontalList itemSize="stretch">
                            <ListItem style={{ marginRight: "1rem" }}>
                                <InputSelect
                                    ...
                                    label={<label style={{ display: "inline-block" }}>Contract <span style={{ color: "red" }}>*</span></label>}
                                    labelInValue
                                ...
                                >
                                    {contractList.map(function (contract) {
                                        return (
                                            <Select.Option key={contract.id} value={contract.id}>{getObjectTrans(contract.name)}</Select.Option>
                                        )
                                    })}
                                </InputSelect>
                            </ListItem>
                        ...
                        ? <HorizontalList itemSize="stretch">
                            <ListItem style={{ marginRight: "1rem" }}>
                                <InputSelect
                                    ...
                                    label={<label style={{ display: "inline-block" }}>Department <span style={{ color: "red" }}>*</span></label>}
                                    labelInValue
                                ...
                                >
                                    {departmentList.map(function (department) {
                                        return (
                                            <Select.Option key={department.id} value={department.id}>{getObjectTrans(department.name)}</Select.Option>
                                        )
                                    })}
                                </InputSelect>
                            </ListItem>
...
export default AdminJobsCreatePage;
