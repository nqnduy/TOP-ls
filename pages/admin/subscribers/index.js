        ...
        },
        {
            ...
            render: function renderActive(status, row, index) {
                return (
                    <>
                        { status == true
                            ? <AdminBadge style={{marginBottom: '5px', marginRight: '5px'}} size={ButtonSize.SMALL} type={ButtonType.SUCCESS}>Active</AdminBadge>
                            : ''}
                        { status == false 
                            ? <AdminBadge style={{marginBottom: '5px', marginRight: '5px'}} size={ButtonSize.SMALL} type={ButtonType.DANGER}>In-Active</AdminBadge>
                            : ''}
                    </>
                );
            }
