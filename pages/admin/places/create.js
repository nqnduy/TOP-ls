...
const AdminPlaceCreatePage = ({ user }) => {
            ...
            <Section borderBottom={true} style={{ padding: "2rem 0" }}>
                <HorizontalList style={{width: '50%', marginTop: "5px"}}>
                    <ListItem style={{ marginRight: "1rem" }}>
                        ...
                        <SingleImage
                            name={'image'}
                            imageUrl={formInput ? formInput.imageUrl: ""}
                ...
                <HorizontalList itemSize={ListItemSize.STRETCH}>
                    ...
                    <ListItem style={{ marginRight: "1rem" }}>
                        ...
                        >
                            {arrayOpenTime? arrayOpenTime.map((item, index) => (
                    ...
                    <AdminButton
                        size={ButtonSize.LARGE}
                        onClick={resetOpeningHours}
                        style={{margin: '20px'}}
                    >
                        Reset Hour List 
                    </AdminButton>
                </HorizontalList>
                <Divider orientation="left" style={{marginTop: "30px"}}>Address Informations</Divider>
                ...
                <HorizontalList itemSize={ListItemSize.STRETCH}>
                    <ListItem style={{ marginRight: "1rem", width: "50%" }}>
                        ...
                        onChange={onchangeProvince}>
                            ...
                            <Option key={province.id} name={province.name.vi}>{province.name.vi}</Option>
                            ))}
                        </Select>
                    </ListItem>
                </HorizontalList>
                    ...
                    <ListItem style={{ marginRight: "1rem", width: "50%" }}>
                        <Select
                            ...
                            {zoneDistrictData.map(district => (
                                <Option key={district.id} value={district.id} name={district.name.vi}>{district.name.vi}</Option>
                            ))}
                        </Select>
                    </ListItem>
                </HorizontalList>
                    ...
                    <ListItem style={{ marginRight: "1rem", width: "50%" }}>
                        <Select
                            ...
                            {zoneWardData.map(ward => (
                                <Option key={ward.id} value={ward.id} name={ward.name.vi}>{ward.name.vi}</Option>
                            ))}
                        </Select>
                    </ListItem>
                </HorizontalList>
                ...
                {displayListPlace===true? <Divider orientation="left" style={{marginTop: "30px"}} >List Place</Divider>:""}
                <div ref={el => formInputRef.current.list = el}></div>
                <HorizontalList itemSize={ListItemSize.STRETCH}>
                    <Radio.Group style={{width:"1200px"}} onChange={onChangePlaceId}>
                    {listPlace? listPlace.map(place => (  
