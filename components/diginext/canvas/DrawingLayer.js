...
export default class DrawingLayer extends Component {
	...
	backgroundBoundFunc(pos) {
		...
		if (newX < scope.stage.width() - bg.width()) newX = scope.stage.width() - bg.width();
		if (newY < scope.stage.height() - bg.height()) newY = scope.stage.height() - bg.height();
