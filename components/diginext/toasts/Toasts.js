...
const ContainerToast = forwardRef((props, ref) => {
...
ContainerToast.displayName = "ContainerToast";
				...
				{toastList.map((toast, i) => (
					...
					>
						...
						<div className="notification-image">
							<Image class="img" src={toast.icon} alt="" />
						</div>
						<div>
...
export { ContainerToast, ButtonToast, Toast };
