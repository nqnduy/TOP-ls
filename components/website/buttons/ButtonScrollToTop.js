 ...
 */
function ScrollToTop({ background = "#ffffff", positionBottom = 40, activePosition = null, ...rest }) {
	...
	return (
		<button className={["btn-scroll-to-top", _stateClassName].join(" ")} onClick={handleClick} {...rest}>
			<span className="icon">
				<Image className="img" src={asset("/vercel.svg")} alt="" layout="fill" />
			</span>
