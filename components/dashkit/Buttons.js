 ...
 * @param  {("normal"|"small"|"large")} [props.size="normal"]
 * @param  {("primary"|"secondary"|"success"|"danger"|"warning"|"info"|"light"|"dark"|"transparent")} [props.type="primary"]
 * @param  {("rect"|"round_rect"|"round_rect_left"|"round_rect_right"|"round"|"round_left"|"round_right"|"circle")} [props.shape="round_rect"]
 */
const DashkitButton = ({
	children,
	onClick,
